...
public class SVGGraphics extends Graphics2D{
	...
	private final Graphics2D processingGraphics;
	
	private final SVGGraphics2D svgGraphics;

	SVGGraphics(final Graphics2D processingGraphics){
		DOMImplementation domImpl = GenericDOMImplementation.getDOMImplementation();
		Document document = domImpl.createDocument(null, "svg", null);
		svgGraphics = new SVGGraphics2D(document);
		this.processingGraphics = processingGraphics;
	}
	
	SVGGraphics(final SVGGraphics graphics){
		this.processingGraphics = graphics.processingGraphics;
		this.svgGraphics = graphics.svgGraphics;
	}
    ...
    public boolean drawImage(Image img,AffineTransform xform,ImageObserver obs){
		return processingGraphics.drawImage(img,xform,obs) &&
			svgGraphics.drawImage(img,xform,obs);
    }
    ...
    public void drawImage(BufferedImage img,BufferedImageOp op,int x,int y){
		processingGraphics.drawImage(img,op,x,y);
		svgGraphics.drawImage(img,op,x,y);
    }
    ...
    public void drawRenderedImage(RenderedImage img,AffineTransform xform){
		processingGraphics.drawRenderedImage(img,xform);
		svgGraphics.drawRenderedImage(img,xform);
    }
    ...
    public void drawRenderableImage(RenderableImage img,AffineTransform xform){
		processingGraphics.drawRenderableImage(img,xform);
		svgGraphics.drawRenderableImage(img,xform);
    }
    ...
    public void drawString(String str, int x, int y){
		processingGraphics.drawString(str, x, y);
		svgGraphics.drawString(str, x, y);
    }
    ...
    public void drawString(AttributedCharacterIterator iterator,int x, int y){
		processingGraphics.drawString(iterator, x, y);
		svgGraphics.drawString(iterator, x, y);
    }
    ...
    public void drawGlyphVector(GlyphVector g, float x, float y){
		processingGraphics.drawGlyphVector(g, x, y);
		svgGraphics.drawGlyphVector(g, x, y);
    }
    ...
    public boolean hit(Rectangle rect, Shape s, boolean onStroke){
		return processingGraphics.hit(rect,s,onStroke);
    }
    ...
    public GraphicsConfiguration getDeviceConfiguration(){
		return processingGraphics.getDeviceConfiguration();
    }
    ...
    public void setComposite(Composite comp){
		processingGraphics.setComposite(comp);
		svgGraphics.setComposite(comp);
    }
    ...
    public void setPaint(Paint paint){
		processingGraphics.setPaint(paint);
		svgGraphics.setPaint(paint);
    }
    ...
    public void setStroke(Stroke s){
		processingGraphics.setStroke(s);
		svgGraphics.setStroke(s);
    }
    ...
    public void setRenderingHint(RenderingHints.Key hintKey, Object hintValue){
		processingGraphics.setRenderingHint(hintKey,hintValue);
		svgGraphics.setRenderingHint(hintKey,hintValue);
    }
    ...
    public Object getRenderingHint(RenderingHints.Key hintKey){
		return processingGraphics.getRenderingHint(hintKey);
    }
    ...
    public void setRenderingHints(Map hints){
		processingGraphics.setRenderingHints(hints);
    ...
    public void addRenderingHints(Map hints){
		processingGraphics.addRenderingHints(hints);
		svgGraphics.addRenderingHints(hints);
    }
    ...
    public RenderingHints getRenderingHints(){
		return processingGraphics.getRenderingHints();
    }
    ...
    public void translate(int x, int y){
		processingGraphics.translate(x,y);
    ...
    public void rotate(double theta){
		processingGraphics.rotate(theta);
		svgGraphics.rotate(theta);
    }
    ...
    public void rotate(double theta, double x, double y){
		processingGraphics.rotate(theta,x,y);
		svgGraphics.rotate(theta,x,y);
    }
    ...
    public void scale(double sx, double sy){
		processingGraphics.scale(sx,sy);
		svgGraphics.scale(sx,sy);
    }
    ...
    public void shear(double shx, double shy){
		processingGraphics.shear(shx,shy);
		svgGraphics.shear(shx,shy);
    }
    ...
    public void transform(AffineTransform tx){
		processingGraphics.transform(tx);
		svgGraphics.transform(tx);
    }
    ...
    public void setTransform(AffineTransform tx){
		processingGraphics.setTransform(tx);
		svgGraphics.setTransform(tx);
    }
    ...
    public AffineTransform getTransform(){
		return processingGraphics.getTransform();
    }
    ...
    public Paint getPaint(){
		return processingGraphics.getPaint();
    }
    ...
    public Composite getComposite(){
		return processingGraphics.getComposite();
    }
    ...
    public void setBackground(Color color){
		processingGraphics.setBackground(color);
		svgGraphics.setBackground(color);
    }
    ...
    public Color getBackground(){
		return processingGraphics.getBackground();
    }
    ...
    public Stroke getStroke(){
		return processingGraphics.getStroke();
    }
    ...
    public FontRenderContext getFontRenderContext(){
		return processingGraphics.getFontRenderContext();
    }
    ...
    public Color getColor(){
		return processingGraphics.getColor();
    }
    ...
    public void setColor(Color c){
		processingGraphics.setColor(c);
		svgGraphics.setColor(c);
    }
    ...
    public void setPaintMode(){
		processingGraphics.setPaintMode();
		svgGraphics.setPaintMode();
    }
    ...
    public void setXORMode(Color c1){
		processingGraphics.setXORMode(c1);
		svgGraphics.setXORMode(c1);
    }
     ...
     */
    public Font getFont(){
		return processingGraphics.getFont();
    }
    ...
    */
    public void setFont(Font font){
		processingGraphics.setFont(font);
		svgGraphics.setFont(font);
    }
    ...
    public FontMetrics getFontMetrics(Font f){
		return processingGraphics.getFontMetrics(f);
    }
    ...
    public Rectangle getClipBounds(){
		return processingGraphics.getClipBounds();
    }
    ...
    public void clipRect(int x, int y, int width, int height){
		processingGraphics.clipRect(x,y,width,height);
		svgGraphics.clipRect(x,y,width,height);
    }
    ...
    public void setClip(int x, int y, int width, int height){
		processingGraphics.setClip(x,y,width,height);
		svgGraphics.setClip(x,y,width,height);
    }
    ...
    public Shape getClip(){
		return processingGraphics.getClip();
    }
    ...
    public void setClip(Shape clip){
		processingGraphics.setClip(clip);
		svgGraphics.setClip(clip);
    }
    ...
    public void copyArea(int x, int y, int width, int height, int dx, int dy){
		processingGraphics.copyArea(x, y, width, height, dx, dy);
		svgGraphics.copyArea(x, y, width, height, dx, dy);
    }
    ...
    public void drawLine(int x1, int y1, int x2, int y2){
		processingGraphics.drawLine(x1, y1, x2, y2);
    ...
    public void fillRect(int x, int y, int width, int height){
		processingGraphics.fillRect(x, y, width, height);
		svgGraphics.fillRect(x, y, width, height);
    }
    ...
    public void clearRect(int x, int y, int width, int height){
		processingGraphics.clearRect(x, y, width, height);
		svgGraphics.clearRect(x, y, width, height);
    }
    ...
    public void fillRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight){
		processingGraphics.fillRoundRect(x, y, width, height, arcWidth, arcHeight);
		svgGraphics.fillRoundRect(x, y, width, height, arcWidth, arcHeight);
    }    
    ...
    public void drawOval(int x, int y, int width, int height){
		processingGraphics.drawOval(x, y, width, height);
		svgGraphics.drawOval(x, y, width, height);
    }
    ...
    public void fillOval(int x, int y, int width, int height){
		processingGraphics.fillOval(x, y, width, height);
		svgGraphics.fillOval(x, y, width, height);
    }
    ...
    public void drawArc(int x, int y, int width, int height, int startAngle, int arcAngle){
		processingGraphics.drawArc(x, y, width, height, startAngle, arcAngle);
    ...
    public void drawPolyline(int xPoints[], int yPoints[], int nPoints){
		processingGraphics.drawPolyline(xPoints, yPoints, nPoints);
		svgGraphics.drawPolyline(xPoints, yPoints, nPoints);
    }
    ...
    public void drawPolygon(int xPoints[], int yPoints[], int nPoints){
		processingGraphics.drawPolygon(xPoints, yPoints, nPoints);
		svgGraphics.drawPolygon(xPoints, yPoints, nPoints);
    }
    ...
    public void fillPolygon(int xPoints[], int yPoints[], int nPoints){
		processingGraphics.fillPolygon(xPoints, yPoints, nPoints);
		svgGraphics.fillPolygon(xPoints, yPoints, nPoints);
    }
    ...
    public boolean drawImage(Image img, int x, int y, ImageObserver observer){
		return processingGraphics.drawImage(img, x, y, observer) &&
			svgGraphics.drawImage(img, x, y, observer);
    }
    ...
    public boolean drawImage(Image img, int x, int y, Color bgcolor, ImageObserver observer){
		return processingGraphics.drawImage(img, x, y, bgcolor, observer) &&
		svgGraphics.drawImage(img, x, y, bgcolor, observer);
    }
    ...
    public boolean drawImage(Image img, int x, int y, int width, int height, Color bgcolor, ImageObserver observer){
		return processingGraphics.drawImage(img, x, y, width, height, bgcolor, observer) &&
		svgGraphics.drawImage(img, x, y, width, height, bgcolor, observer);
    }
    ...
    public boolean drawImage(Image img,int dx1, int dy1, int dx2, int dy2,int sx1, int sy1, int sx2, int sy2,ImageObserver observer){
		return processingGraphics.drawImage(img, dx1, dy1, dx2, dy2,sx1, sy1, sx2, sy2,observer) &&
		svgGraphics.drawImage(img, dx1,dy1, dx2, dy2,sx1, sy1, sx2, sy2,observer);
    }
    ...
    public boolean drawImage(Image img,int dx1, int dy1, int dx2, int dy2,int sx1, int sy1, int sx2, int sy2,Color bgcolor, ImageObserver observer){	
		return processingGraphics.drawImage(img, dx1, dy1, dx2, dy2,sx1, sy1, sx2, sy2, bgcolor, observer) &&
		svgGraphics.drawImage(img, dx1,dy1, dx2, dy2,sx1, sy1, sx2, sy2, bgcolor, observer);
    }
